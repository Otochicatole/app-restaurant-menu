...
export function createTemplateDocument(name: string): CanvasDocumentV1 {
  return {
    ...
    nodes: [
      ...
      { id: "template-card", type: "shape", x: 80, y: 300, width: 720, height: 300, rotation: 0, opacity: 1, visible: true, locked: false, groupId: null, link: null, shape: "rect", fill: "#EAD8B8", stroke: "#B8790A", strokeWidth: 3, strokeSides: [...STROKE_SIDES], cornerRadius: 24 },
