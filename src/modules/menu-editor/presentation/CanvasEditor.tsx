...
function ShapeInspector({ node, onChange }: { node: Extract<CanvasNode, { type: "shape" }>; onChange: (patch: Partial<CanvasNode>) => void }) {
  ...
  const radius = Math.min(node.cornerRadius, maxRadius);
