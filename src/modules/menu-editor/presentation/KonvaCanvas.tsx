...
export function KonvaCanvas({ document, assets, selectedIds, onSelect, onSelectMany, onDropItem, onChange, onChangeMany, viewport, onViewportChange }: {
